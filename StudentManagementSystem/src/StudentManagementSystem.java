...
public class StudentManagementSystem {
    ...
    private static void mergeSortStudents(List<Student> list, int left, int right) {
        if (left < right) {
    ...
    private static void merge(List<Student> list, int left, int mid, int right) {
        ...
        while (i <= mid && j <= right) {
            if (temp.get(i).marks >= temp.get(j).marks) {
    ...
    private static void mergeSortStudents() {
